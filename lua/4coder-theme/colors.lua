...
M.default = {
	...
	coder_at_cursor = M.coder_background,
	coder_highlight_cursor_line = hsl(0, 0, 12),
	coder_highlight = hsl(64, 100, 47),
	coder_mark = hsl(0, 0, 49),
	coder_text_default = hsl(100, 23, 60),
	coder_at_highlight = hsl(311, 100, 63),
	coder_comment = hsl(208, 87, 53),
	coder_comment_pop = { hsl(120, 100, 31), hsl(0, 100, 31) },
	coder_keyword = hsl(38, 73, 47),
	coder_str_constant = hsl(111, 100, 59),
	coder_char_constant = M.coder_str_constant,
	coder_int_constant = M.coder_str_constant,
	coder_float_constant = M.coder_str_constant,
	coder_bool_constant = M.coder_str_constant,
	coder_include = M.coder_str_constant,
	coder_preproc = M.coder_text_default,
	coder_special_character = hsl(0, 100, 50),
	coder_ghost_character = hsl(100, 15, 32),
	coder_paste = hsl(64, 100, 47),
	coder_undo = hsl(184, 100, 47),
	coder_highlight_junk = hsl(0, 100, 11),
