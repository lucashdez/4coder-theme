...
M.default = {
	...
	coder_constant_builtin = hsl(55, 100, 47),
	...
	coder_str_constant = hsl(111, 100, 40),
	coder_str_special = hsl(150, 80, 50),
	coder_char_constant = hsl(111, 100, 40),
	coder_int_constant = hsl(111, 100, 40),
	coder_float_constant = hsl(111, 100, 40),
	coder_bool_constant = hsl(111, 100, 40),
	coder_include = hsl(111, 100, 40),
