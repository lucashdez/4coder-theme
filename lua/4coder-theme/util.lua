local ts = require("4coder-theme.treesitter")
local M = {}
...
function M.invert_color(color)
	local hsluv = require("4coder-theme.hsluv")
	if color ~= "NONE" then
...
function M.autocmds(config)
	local group = vim.api.nvim_create_augroup("4coder-theme", { clear = true })
...
function M.load(theme)
	...
	vim.g.colors_name = "4coder-theme"
